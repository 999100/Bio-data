...
function Family() {
  ...
  const familyDetails = [
    ...
    { label: "Family Values", value: "Traditional + Modern" },
  ...
  const brothersDetails = [
    { label: "Brother 1", value: "Name Here" },
    { label: "Brother 2", value: "Name Here" },
    { label: "Brother 3", value: "Name Here" },
    { label: "Brother 4", value: "Name Here" },
    { label: "Brother 5", value: "Name Here" },
    { label: "Brother 6", value: "Name Here" },
  ];
